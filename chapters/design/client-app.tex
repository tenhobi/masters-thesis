...
Servers set the~\mintinline{text}|Access-Control-Allow-Origin| header, and if matched with the~origin, a~browser allows the~application\linebreak{}to view and process its response. The~header must be in format
\linebreak
\mintinline{text}/Access-Control-Allow-Origin: <origin> | */.
