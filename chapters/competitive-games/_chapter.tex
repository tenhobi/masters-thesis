...
As mentioned, the criteria are comprehensibility (\mintinline{text}{CO}), story (\mintinline{text}{ST}), study materials (\mintinline{text}{SM}), feedback (\mintinline{text}{FB}), and whether the game is free of charge (\mintinline{text}{FC}).
