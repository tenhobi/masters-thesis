...
Command \mintinline{text}|move <direction>| moves Karel one square in the~chosen direction.
...
The~\mintinline{text}|while <condition>| command works similarly to the~\mintinline{text}|if <condition>| command.
