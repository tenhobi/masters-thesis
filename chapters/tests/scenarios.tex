...
\begin{description}
    ...
    \item[Expected result] a~user is expected to click the~learning mission circle, then click on the~\textquote*{read} button, complete the~learning process, and return to the~story screen by clicking a~\textquote*{back to story} button.
\end{description}
...
\begin{description}
    ...
    \begin{enumerate}
        ...
        \item Run the~game.
    \end{enumerate}
    \item[Expected result] a~user is expected to click the~game mission circle and click on the~\textquote*{play} button.
...
\begin{description}
    ...
    \item[Expected result] a~user is expected to find a~\textquote*{Press} tab on the~about-us screen.
...
\begin{description}
    ...
    \item[Expected result] a~user is expected to
    find a~\textquote*{Sign Out} button inside of a~menu option under an~avatar icon.
    Then they should navigate to the~sign-in screen
    by clicking the~\textquote*{Sign In} button in the~menu.    
\end{description}
